...
class WvnLearning:
    ...
    def learning_thread_loop(self):
        ...
        while True:
            ...
            if abs(ts - self._last_checkpoint_ts) > 1.0 / self._ros_params.load_save_checkpoint_rate:
                ...
                # fn = os.path.join(WVN_ROOT_DIR, "last_checkpoint.pt")
                # fn = os.path.join(WVN_ROOT_DIR, "mountain_bike_trail_v2.pt")
                # fn = os.path.join(WVN_ROOT_DIR, "test.pt")
                # fn = os.path.join(WVN_ROOT_DIR, "/results/2024-10-22T07-58-43_test/last_checkpoint.pt")
    ...
    def load_checkpoint_callback(self, req):
        ...
        # if req.checkpoint_path == os.path.join(WVN_ROOT_DIR, "/results/2024-10-22T07-58-43_test/last_checkpoint.pt"):
